    ...
    <>
      <section className="border-b border-slate-200 bg-slate-50/50 dark:border-slate-800 dark:bg-slate-900/30">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Supplier Opportunities</h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Readiness Driven + Procurement Driven — Suppliers unlock opportunities after readiness validation,
            procurement satisfaction, and supplier satisfaction.
          </p>
        </div>
      </section>
      <Section>
        <ul className="space-y-4" role="list">
          {SUPPLIER_OPPORTUNITIES.map((opp) => (
            <li
              key={opp.id}
