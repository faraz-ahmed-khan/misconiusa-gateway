    ...
    <>
      <section className="border-b border-slate-200 bg-slate-50/50 dark:border-slate-800 dark:bg-slate-900/30">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          ...
          <AnimateIn delay={0.1} variant="fadeUp"><p className="mt-2 text-slate-600 dark:text-slate-400">One subscription pack only. Your subscription activates your readiness routing and enables opportunity eligibility.</p></AnimateIn>
        </div>
      </section>
      <Section>
        <div className="mx-auto max-w-xl"><AnimateIn variant="fadeUp"><PricingBlock pack={SUBSCRIPTION_PACK} /></AnimateIn></div>
